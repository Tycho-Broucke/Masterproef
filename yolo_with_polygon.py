...
def draw_polygon(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        # Draw the polygon on the image while moving the mouse
        if drawing:
        ...
        drawing = False
        polygon_points.append((x, y))  # Complete the polygon
...
# Wait until user finishes drawing the polygon (press "ENTER")
print("Draw a polygon and press 'ENTER' to proceed.")
while True:
